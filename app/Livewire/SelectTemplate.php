...
{
    public $templates = [
        [ 'template 1', 'https://images.unsplash.com/photo-1699100329878-7f28bb780787?auto=format&fit=crop&q=60&w=600&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxMHx8fGVufDB8fHx8fA%3D%3D', 'chat bot'],
        ['template 2', 'https://media.istockphoto.com/id/1474993860/photo/mockup-for-social-media-post-with-photo-carousel.webp?b=1&s=170667a&w=0&k=20&c=XrIUwn0Mr8eNnY52jcwH43bIXYg7zkEPdKr8mzLmI3I=' ,'image slider'],
        ['template 3', 'https://plus.unsplash.com/premium_photo-1681487807762-98fbe8a9db5e?auto=format&fit=crop&q=60&w=600&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGNoYXR8ZW58MHx8MHx8fDA%3D', 'Audio Conversation'],
        ['template 4', 'https://media.istockphoto.com/id/1413855189/photo/chat-bot-service-concept-virtual-assistant-and-crm-software-automation-technology-customer.jpg?s=612x612&w=0&k=20&c=5wY13TF0YQWF_Ktt0HU9CcjRE6h0wvBpxG78XSLU0-U=',  'Chat with Images'],
        ['template 5', 'https://media.istockphoto.com/id/1356965747/photo/businesswoman-watching-a-live-business-stream-online-live-stream-window-video-streaming-on.jpg?s=612x612&w=0&k=20&c=PABQURWQhJAhR84qoU1RwoaMfh2eQp2LOgtfjV-mhwM=', 'Chat with Videos'],
        ['template 6', 'https://media.istockphoto.com/id/1461083586/photo/half-folded-flyer-a4-booklet-mock-up-on-white-background.webp?b=1&s=170667a&w=0&k=20&c=fjw90yGrGs0XV_RcWtgRfbZ3mDOrZqnw_yzmXuSrRyQ=', 'Keywords and response'],
        ['template 7', 'https://media.istockphoto.com/id/1461083586/photo/half-folded-flyer-a4-booklet-mock-up-on-white-background.webp?b=1&s=170667a&w=0&k=20&c=fjw90yGrGs0XV_RcWtgRfbZ3mDOrZqnw_yzmXuSrRyQ=','Book Appointment'],
    ];
    ...
    public function selectedTemplate($id)
    {
        switch ($id) {
            ...
            case 'template 6':
                ...
                break;
            case 'template 7':
                $this->conversation->template = 'temp7';
                break;
