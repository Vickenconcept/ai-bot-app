<x-app-layout>
    ...
    {{-- <div class="flex  w-full justify-center items-center ">
        <div class="w-32   bg-red-400">
            <P>Indeed you made a great decision because ConvergeAI works and we are here to help you
            ...
            <div class="bg-white  p-5 sm:p-10 text-center w-[80%] mx-auto space-y-5 text-gray-700">
                  ...
                  <div class="grid grid-cols-1 lg:grid-cols-5">
                    ...
                    <div class="rounded shadow-md p-5 col-span-3 space-y-5">
                        ...
                        <p class="text-sm">Indeed you made a great decision because ConvergeAI works and we are here to help you
                            get an outstanding result too like other early adopters.</p>
