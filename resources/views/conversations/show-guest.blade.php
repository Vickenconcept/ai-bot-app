<x-guest-layout>
    ...
    <div class="">
        ...
        <nav class=" fixed flex px-5 py-3 top-0 w-full shadow {{ $conversationTitle->nav_bg_color }}bg-purple-900 text-white"
            ...
            @if (auth()->check())
                <a href="{{ route('conversations.index')}}" class="self-center px-1 hover:border-b border-gray-50 justify-self-center" ><i class='bx bxs-chevron-left'></i>Back</a>
            @endif
        </nav>
