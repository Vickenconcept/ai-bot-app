<nav class="bg-blue-900 sticky top-0 z-10" x-data="{ openMobileMenue: false , open: true }">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button type="button"
                @click="openHelp = true"   
                    class="relative rounded-full text-sm px-2 bg-gray-800 py-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    Get Help
                </button>
