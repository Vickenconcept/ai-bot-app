<div>
    <form action="">
        ...
        <select id="countries"  wire:model="lang" wire:change="selectLanguage"
            ...
            <option @if($conversation->lang == 'FR') selected @endif value="FR">France</option>
