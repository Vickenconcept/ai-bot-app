    <div class="space-y-8" >
        ...
        <div class="flex flex-col lg:flex-row space-y-3 lg:justify-between">
            ...
            <div class="flex flex-col lg:flex-row space-y-3 lg:space-y-0 lg:justify-between lg:space-x-3  card-animate">
                <div>
                    <x-main-button class="text-gray-50 " onclick="deleteSelectedItems()">Action <i class='bx bx-dots-vertical-rounded'></i></x-main-button>
                    {{-- <x-dropdown>
                        <x-slot name="trigger">
                            <x-main-button class="text-gray-50 ">Action <i class='bx bx-dots-vertical-rounded'></i></x-main-button>
                        </x-slot>
                        <x-slot name="content">
                        ...
                        <tr class="bg-white border-b  hover:bg-gray-50 ">
                            <th scope="row"
                                ...
                                <input type="checkbox" name="" value="{{ $body->id }}" id=""
                                    class="checkBoxClass">
                                <a href="{{ route('documents.show', ['document' => $body->id]) }}"   class="hover:text-blue-900">{{ $body->title }}</a>
                            </th>
