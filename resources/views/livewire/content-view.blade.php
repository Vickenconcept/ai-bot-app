    <div class="space-y-8" x-data="{ isCheckedAll: false ,isCheckedOne: [] }">
                ...
                <thead class="text-xs text-gray-700 uppercase bg-gray-50  ">
                    <tr>
                        <th scope="col" class="px-6 py-3 ">
                            <input type="checkbox" name="" id="checkAll"  x-model="isCheckedAll"> <span>name</span>
                        </th>
                        <th scope="col" class="px-6 py-3">
                            Status
                        </th>
                    ...
                    @forelse ($body as $body)
                        <tr class="bg-white border-b  hover:bg-gray-50 ">
                            <th scope="row"
                                ...
                                <input type="checkbox" name="" value="{{ $body->id }}" id="" x-model="isCheckedOne"
                                    class="checkBoxClass">
